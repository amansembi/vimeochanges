...
class WP_DGV_List_Table extends \WP_List_Table {
	...
	public function column_title( $item ) {
		...
		$actions['delete'] = sprintf('<a href="javascript:void(0)" data-id="%d" title="%s">%s</a>',  $item->ID, __('Vimeo video link', 'wp-vimeo-videos-delete'), __('Delete', 'wp-vimeo-videos-delete'));
		
		$actions['delpopwrap'] = sprintf('<div class="delpop"><h2>Are you sure?</h2> <ul><li><span class="cancelpopbtn">Cancel</span></li><li><span class="delpopbtn">Delete</span></li></ul></div>');
